...
public class AgoraVideoChat : Photon.MonoBehaviour
{
    ...
    [SerializeField] private string appID = "a40a4d6251b448ce97e7aec2cdf9d86c";
    [SerializeField] private string channel = "unity3ddemo";
    ...
    [SerializeField] private float spaceBetweenUserVideos = 100f;
    ...
    private void CreateUserVideoSurface(uint uid, bool isLocalUser)
    {
        ...
        Vector3 spawnPosition = new Vector3(0, 160-spawnY, 0);
